...
LOAD DATA INFILE '/home/db/testdb_dismission_reason.csv'
INTO TABLE dismission_reason
FIELDS TERMINATED BY ';'
LINES TERMINATED BY '\n'
IGNORE 1 ROWS;

LOAD DATA INFILE '/home/db/testdb_position.csv'
INTO TABLE position
FIELDS TERMINATED BY ';'
LINES TERMINATED BY '\n'
IGNORE 1 ROWS;

LOAD DATA INFILE '/home/db/testdb_department.csv'
INTO TABLE department
FIELDS TERMINATED BY ';'
LINES TERMINATED BY '\n'
IGNORE 1 ROWS;

LOAD DATA INFILE '/home/db/testdb_user.csv'
INTO TABLE user
FIELDS TERMINATED BY ';'
LINES TERMINATED BY '\n'
IGNORE 1 ROWS;

LOAD DATA INFILE '/home/db/testdb_user_dismission.csv'
INTO TABLE user_dismission
FIELDS TERMINATED BY ';'
LINES TERMINATED BY '\n'
IGNORE 1 ROWS;

LOAD DATA INFILE '/home/db/testdb_user_position.csv'
