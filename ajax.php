<?php
include_once 'ContentBuilder.php';
include_once 'db.php';
include_once 'config.php';

if(isset( $_GET['check'] )) { echo json_encode(ajaxResponser()); }
function ajaxResponser() {
    ...
    if(isset( $_GET['check'] )) { $query = $_GET['check']; }
    ...
    $builder = new ContentBuilder( $mysqli, $sql );
